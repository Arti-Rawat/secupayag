...
CREATE TABLE `api_apikey`  (
  ...
  `apikey` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `transaktion_transaktionen`  (
  ...
  `beschreibung` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
CREATE TABLE `vorgaben_datensatz_typ`  (
  ...
  `beschreibung` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `vorgaben_flagbit`  (
  ...
  `beschreibung` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `tabellen` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'nur als notiz, wird nicht ausgewertet',
